...
describe('calculateFallbackMode', () => {
  it('should return BLOCKING_STATIC_RENDER when root params exist', () => {
  ...
  it('should return the base fallback mode when no root params exist', () => {
    const result = calculateFallbackMode([], FallbackMode.PRERENDER)

    expect(result).toBe(FallbackMode.PRERENDER)
  })

  it('should preserve blocking fallback when no root params exist', () => {
    const result = calculateFallbackMode(
      [],
  ...
  it('should return NOT_FOUND when no fallback mode is available', () => {
    const result = calculateFallbackMode([], undefined)
